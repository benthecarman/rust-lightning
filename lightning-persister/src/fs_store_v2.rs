...
impl FilesystemStoreV2 {
	...
	pub fn new(data_dir: PathBuf) -> std::io::Result<Self> {
		...
		Ok(Self { inner: FilesystemStoreState::new(data_dir) })
	}
...
impl PaginatedKVStore for FilesystemStoreV2 {
	...
	{
		self.inner.list_paginated_async(primary_namespace, secondary_namespace, page_token)
	}
}
